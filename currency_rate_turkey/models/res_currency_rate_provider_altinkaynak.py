# Copyright 2025 Yiğit Budak, Ümithan Güldemir (https://github.com/yibudak)
...
class ResCurrencyRateProviderTCMB(models.Model):
    ...
    service_rate_type = fields.Selection(
        [
            ("AltinkaynakBuying", _("Altinkaynak Buying")),
            ("AltinkaynakSelling", _("Altinkaynak Selling")),
        ],
        string="Service Rate Type",
        required=True,
        default="AltinkaynakBuying",
    )
